...
public static void main(String[] args) {
		//testing
		String an = "UNIVERSITAS SULAWESI BARAT";
		System.out.println("Bentuk Plaintextnya adalah	:"+an);
		
		String as = encript(an);
		System.out.println("Bentuk Enkripsinya adalah	:"+as);
		
		String an1 = descript(as);
		System.out.println("Bentuk Dekripsinya adalah	:"+an1);                     
